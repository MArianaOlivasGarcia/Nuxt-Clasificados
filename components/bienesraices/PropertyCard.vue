...
<template>
  ...
  <a :href="route" class="card" target="_blank">
    ...
    <div class="card-body">
        <div>
            <h5 v-if="property.price" class="card-title pricecard m-0">$ {{ property.price }} {{ property.currency }}</h5>
            <h5 v-if="!property.price" class="card-title pricecard m-0">Consultar el precio</h5>
